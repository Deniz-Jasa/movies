...
const ShowModal = () => {
  ...
  return (
    ...
    >
      <DialogContent className="w-[85%] sm:w-[40%] overflow-hidden rounded-md bg-background p-0 text-left align-middle shadow-xl sm:max-w-3xl lg:max-w-4xl xl:h-[70vh] h-auto sm:h-[80vh] flex flex-col">
