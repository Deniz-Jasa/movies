...
const ShowModal = () => {
  ...
  return (
    ...
    >
      <DialogContent className="w-[90%] sm:w-[40%] overflow-hidden rounded-md bg-zinc-900 p-0 text-left align-middle shadow-xl dark:bg-zinc-900 sm:max-w-3xl lg:max-w-4xl xl:h-[70vh] h-auto sm:h-[80vh] flex flex-col">
